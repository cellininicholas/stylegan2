...
Will not build IM without

```
sudo apt-get install -y libltdl-dev
```

follow https://www.tecmint.com/install-imagemagick-on-debian-ubuntu/
to install imagemagick

### set up as in INSTALL or try:
